...
![PostgreSQL](https://img.shields.io/badge/PostgreSQL%20%2F%20PostGIS-4169E1?style=for-the-badge&logo=postgresql&logoColor=white)
...
|---|---|---|
| 🏘️ **RR App** | Real-estate data platform for cadastral data & market analytics. Playwright scraper for PR government property-sales data. | Python · FastAPI · Playwright · PostgreSQL/PostGIS · Heroku |
| 🎯 **AI Goal Agent** | LLM agent that plans New Year's resolutions, schedules them in Google Calendar, and re-plans when goals slip. Built at the Encode Club AI Hackathon. | LangGraph · Comet · Full Stack |
...
<p align="center">🗣️ Spanish (native) · English (fluent) &nbsp;|&nbsp; 🎓 Holberton School — Full Stack SWE & Machine Learning</p>
